    ...
    <div className="bg-neumo-surface rounded-neumo-card p-6 shadow-neumo-raised-lg">
      <div className="flex justify-between items-start mb-5">
        ...
        <div className="text-right">
          ...
          <p className="text-xl font-semibold text-brand-v2-gold">
      ...
      <div className="relative h-3 bg-neumo-light rounded-full overflow-hidden mb-5 shadow-neumo-pressed-sm">
        <div
          className="absolute top-0 left-0 h-full rounded-full transition-all duration-500 ease-out
            bg-gradient-to-r from-brand-v2-gold to-[#E8C572]
            shadow-[0_0_12px_rgba(212,162,76,0.4)]"
          style={{ width: `${percent}%` }}
        />
      </div>

      <div className="flex items-center gap-4">
        <div className="w-3.5 h-3.5 rounded-full bg-gradient-to-br from-brand-v2-gold to-[#C99A45] shadow-neumo-raised-sm" />
        <div>
